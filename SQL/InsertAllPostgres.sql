INSERT INTO "userType"("name","flagActive","createdAt","updatedAt") VALUES
	...
	('Médico(a)', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	('Enfermeiro(a)', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	('Paciente', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
    
INSERT INTO "address" ("street","number","city","state","cep","complement", "neighborhood","flagActive","createdAt","updatedAt") VALUES 
	('Rua João Dias de Souza','365','Sorocaba','São Paulo','18048-090','Apto 11','Parque Campolim',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Izabel Maria Rodrigues','100','Sorocaba','São Paulo','18078-130','','Jardim Santa Cecília',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Fernando Rogich Vieira','566','Sorocaba','São Paulo','18071-344','Casa 40','Jardim Santa Helena',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Horácio Cenci','400','Sorocaba','São Paulo','18047-800','','Parque Campolim',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Irmã Dulce','365','Sorocaba','São Paulo','18079-685','Apto 45','Jardim Santa Madre Paulina',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Doutor José Júlio Fernandes de Barros','1001','Sorocaba','São Paulo','18046-100','Apto 72','Jardim dos Estados',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Maria das Graças Arruda P. Nardy','321','Sorocaba','São Paulo','18050-130','','Jardim Vera Cruz',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Quinze de Novembro','40','Sorocaba','São Paulo','18010-080','Apto 33','Centro',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Rua Renato Lucci','123','Sorocaba','São Paulo','18016-329','','Jardim Residencial Martinez',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
	('Praça Maria Cristina Lolatta Pereira','857','Sorocaba','São Paulo','18051-595','','Jardim São Paulo',true,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
...
-- medics
('Allana Louise Olivia Gonçalves',2,'1988-01-17','Feminino',null,'(15) 99589-0415', '','027.004.288-11','32.704.923-6','Eliane Bárbara Simone','allana_goncalves@techdomus.com.br','','',true,now(),now()),
('Daniel Filipe Luiz Oliveira',2,'1988-01-02','Masculino',null,'(15) 99374-5900', '','744.074.268-02','19.901.385-8','Sabrina Luiza','daniel_oliveira@mcexecutiva.com.br','','',true,now(),now()),
('Anderson Victor Yago Farias',2,'1988-01-13','Masculino',null,'(15) 98104-2018', '','866.565.468-20','45.607.838-1','Sebastiana Marina','anderson_farias@tce.am.gov.br','','',true,now(),now()),
-- nurses
('Isabelle Liz Gabrielly da Luz',3,'1968-02-03','Feminino',null,'(19) 3761-0239', '','019.853.288-10','42.194.512-6','Jaqueline Silvana Fátima','isabelle-daluz78@vinax.com.br','','COREN-SP-123456',true,now(),now()),
('Samuel Benedito Henry Cavalcanti',3,'1992-01-06','Masculino',null,'(11) 3795-4573', '','950.867.888-70','46.622.193-9','Clarice Bianca Adriana','samuel-cavalcanti71@jotace.eti.br','','COREN-SP-123456',true,now(),now()),
...
('Rosângela Sara Jaqueline Galvão',3,'1993-02-24','Feminino',null,'(11) 3896-2825', '','046.480.068-44','41.894.123-3','Juliana Carolina','rosangela.sara.galvao@cabletech.com.br','','COREN-SP-123456',true,now(),now()),
('Marina Kamilly Melissa Lopes',3,'1979-02-24','Feminino',null,'(19) 3815-7046', '','530.657.328-23','36.162.967-9','Fernanda Esther','marina.kamilly.lopes@gmnail.com','','COREN-SP-123456',true,now(),now()),
-- patients
('Thales Benjamin da Costa',4,'2000-01-15','Masculino',1,'(15) 93953-5739', '(15) 93953-5739','413.754.998-23','20.894.718-8','Allana Luiza Luana','thales_benjamin_dacosta@amplisat.com.br','','',true,now(),now()),
('Aurora Jéssica Rosângela Fernandes',4,'1987-02-04','Feminino',2,'(15) 93872-5432', '(15) 93872-5432','008.709.188-77','39.529.747-3','Jaqueline Alice Stefany','aurora_jessica_fernandes@santosferreira.adv.br','','',true,now(),now()),
('Sara Yasmin Allana Cardoso',4,'1978-02-18','Feminino',3,'(15) 92733-3081', '(15) 92733-3081','416.318.808-88','42.555.915-4','Louise Emily Tereza','sara_cardoso@nipbr.com','','',true,now(),now()),
('Lorena Lorena Galvão',4,'1964-02-04','Feminino',4,'(15) 93757-6149', '(15) 93757-6149','409.466.258-83','18.352.283-7','Cristiane Ayla Beatriz','lorenalorenagalvao@carubelli.com.br','','',true,now(),now()),
('Rafael Breno Cavalcanti',4,'2006-01-11','Masculino',5,'(15) 92983-2122', '(15) 92983-2122','093.272.158-34','18.907.298-2','Andreia Hadassa','rafael-cavalcanti94@hpelzer.com.br','','',true,now(),now()),
('Isabel Eloá Ramos',4,'1951-01-08','Feminino',6,'(15) 93591-8594', '(15) 93591-8594','504.443.928-23','11.203.282-5','Vera Bárbara','isabel_eloa_ramos@davimil.com.br','','',true,now(),now()),
('Sandra Sara da Paz',4,'1968-02-25','Feminino',7,'(15) 92979-1530', '(15) 92979-1530','320.808.308-48','48.428.829-5','Raimunda Sebastiana','sandra-dapaz77@liv.com','','',true,now(),now()),
('Manoel Heitor Marcos Corte Real',4,'1975-01-06','Masculino',8,'(15) 93683-0707', '(15) 93683-0707','734.219.018-72','10.949.718-1','Agatha Stefany Alice','manoel_cortereal@leandroreis.com','','',true,now(),now()),
('Renato Cláudio Caldeira',4,'1994-02-06','Masculino',9,'(15) 92687-7021', '(15) 92687-7021','257.553.778-98','33.018.469-6','Alessandra Tânia','renato_claudio_caldeira@embraer.com.br','','',true,now(),now()),
('Elza Andreia Andrea da Cruz',4,'1986-02-13','Feminino',10,'(15) 92804-9300', '(15) 92804-9300','165.254.318-08','17.400.697-4','Yasmin Fabiana Tatiane','elza.andreia.dacruz@htmail.com','','',true,now(),now());
...
Alergias a alimentos específicos, controladas com medicação quando necessário.',true,now(),now()),
...
-- Inserir dados na tabela medicalProcedureSection
...
INSERT INTO "medicalProcedure" ("procedureDate", "checkin", "medicalProcedureTypeId", "patientId", "doctorId", "nurseId", "flagActive", "folder") VALUES
  ('2024-08-18 10:00:00', false, 1, 10, 2, 5, true, '1wboDM4ykTR6_beYz3Oz16pHiM9qixZXS'),
  ('2024-07-19 14:30:00', false, 2, 10, 3, 6, true, '1VoazDU6fwElCyG-k8Q6E9-jeFBcErB4g'),
  ('2024-02-20 08:45:00', false, 1, 11, 2, 5, true, '17UQHay84QGZG1Q5nuD3-wLcaouqWJgj_'),
  ('2024-09-21 11:20:00', false, 2, 11, 4, 6, true, '1wboDM4ykTR6_beYz3Oz16pHiM9qixZXS'),
  ('2024-04-22 15:10:00', false, 1, 12, 3, 5, true, '1VoazDU6fwElCyG-k8Q6E9-jeFBcErB4g'),
  ('2024-02-23 09:30:00', false, 3, 13, 3, 6, true, '17UQHay84QGZG1Q5nuD3-wLcaouqWJgj_'),
  ('2024-05-24 13:45:00', false, 3, 14, 3, 7, true, '1wboDM4ykTR6_beYz3Oz16pHiM9qixZXS'),
  ('2024-03-25 10:30:00', false, 4, 15, 3, 8, true, '1VoazDU6fwElCyG-k8Q6E9-jeFBcErB4g'),
  ('2024-03-26 14:15:00', false, 5, 16, 4, 7, true, '17UQHay84QGZG1Q5nuD3-wLcaouqWJgj_'),
  ('2024-03-27 09:00:00', false, 6, 17, 4, 8, true, '1wboDM4ykTR6_beYz3Oz16pHiM9qixZXS'),
  ('2024-03-28 11:45:00', false, 4, 18, 4, 7, true, '1VoazDU6fwElCyG-k8Q6E9-jeFBcErB4g'),
  ('2024-02-29 15:30:00', false, 5, 19, 4, 8, true, '17UQHay84QGZG1Q5nuD3-wLcaouqWJgj_'),
  ('2024-03-30 10:00:00', false, 7, 14, 2, 9, true, '1wboDM4ykTR6_beYz3Oz16pHiM9qixZXS'),
  ('2024-03-31 14:45:00', false, 8, 16, 2, 9, true, '1VoazDU6fwElCyG-k8Q6E9-jeFBcErB4g'),
  ('2024-02-01 08:30:00', false, 7, 15, 2, 9, true, '17UQHay84QGZG1Q5nuD3-wLcaouqWJgj_');
